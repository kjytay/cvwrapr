...
<!-- badges: start -->
[![CRAN status](https://www.r-pkg.org/badges/version/cvwrapr)](https://CRAN.R-project.org/package=cvwrapr)
<!-- badges: end -->
...
See the [package website](https://kjytay.github.io/cvwrapr/index.html) for more examples and documentation.
